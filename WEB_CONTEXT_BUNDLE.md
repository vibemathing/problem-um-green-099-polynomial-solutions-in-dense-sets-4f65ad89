...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-green-099-polynomial-solutions-in-dense-sets-4f65ad89-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GREEN-099"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-green-099-polynomial-solutions-in-dense-sets-4f65ad89-v1",
      "problem_contract_sha256": "a50031521d445c6f110023f3dbc522293923b339cf93ae94ff58039ddf96a537",
      "problem_id": "problem:um-green-099-polynomial-solutions-in-dense-sets-4f65ad89",
      "route_id": "route:um-green-099-polynomial-solutions-in-dense-sets-4f65ad89-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-green-099-polynomial-solutions-in-dense-sets-4f65ad89-source-fidelity-01",
      "graph_id": "graph:um-green-099-polynomial-solutions-in-dense-sets-4f65ad89-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-green-099-polynomial-solutions-in-dense-sets-4f65ad89-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-green-099-polynomial-solutions-in-dense-sets-4f65ad89-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Finding a single solution to a polynomial equation $F(x_1, \\dots, x_n) = C$ can be very difficult. What conditions on $A$ ensure that the number of such solutions in $A$ is roughly $\\alpha^n$ times the number of solutions in $[X]$?"
          },
          "statement_sha256": "8f90b00b291be1e56736023926ae2b8ff05f6eb582ae795dc7435eb08ba5665d"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-green-099-polynomial-solutions-in-dense-sets-4f65ad89-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-green-099-polynomial-solutions-in-dense-sets-4f65ad89-root",
      "route_id": "route:um-green-099-polynomial-solutions-in-dense-sets-4f65ad89-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-green-099-b576369ea570",
        "url": "https://www.unsolvedmath.com/problems/GREEN-099"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
